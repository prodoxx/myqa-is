...
export default ({ mode }) => {
  ...
  return defineConfig({
    ...
    define: {
      ...
      PASSWORD_COOKIE_SECRET: process.env.PASSWORD_COOKIE_SECRET,
      ...
      DIGITAL_OCEAN_ENDPOINT_URL: process.env.DIGITAL_OCEAN_ENDPOINT_URL,
      DIGITAL_OCEAN_REGION: process.env.DIGITAL_OCEAN_REGION,
      DIGITAL_OCEAN_API_ID: process.env.DIGITAL_OCEAN_API_ID,
      DIGITAL_OCEAN_API_KEY: process.env.DIGITAL_OCEAN_API_KEY,
      DIGITAL_OCEAN_BUCKET: process.env.DIGITAL_OCEAN_BUCKET,
      BINANCE_API_KEY: process.env.BINANCE_API_KEY,
      BINANCE_API_SECRET: process.env.BINANCE_API_SECRET,
      BETTER_STACK_LOGS: process.env.BETTER_STACK_LOGS,
